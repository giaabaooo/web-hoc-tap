...
export const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-50 shadow-3">
      {/* Tầng 1: Trắng */}
      <div className="bg-surface-muted px-4 sm:px-6 lg:px-8 py-3 flex justify-between items-center">
        <Link to="/" className="flex items-center gap-2 outline-none focus-visible:ring-2 focus-visible:ring-surface-raised rounded">
          <div className="w-10 h-10 bg-yellow-100 rounded-full flex items-center justify-center font-bold text-yellow-600">Logo</div>
          <div>
